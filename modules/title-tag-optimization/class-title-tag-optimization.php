...
class SEOAutoFix_Title_Tag_Optimization {
    ...
    public function enqueue_assets( $hook ) {
        if ( self::HOOK_SUFFIX !== $hook ) { return; }
    ...
    public function ajax_generate() {
        ...
        try {
            $result = $this->ai_generator->generate( $post_id, $force );
    ...
    public function ajax_apply() {
        ...
        if ( ! $post_id || empty( $new_title ) ) { wp_send_json_error( array( 'message' => 'Invalid data.' ) ); }
