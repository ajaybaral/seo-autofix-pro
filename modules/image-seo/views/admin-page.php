...
<div class="wrap imageseo-admin">
    ...
    <div id="tab-alt-images" class="tab-content" style="display: block;">
        ...
        <!-- Header Buttons -->
        <div class="imageseo-header" style="display: flex; gap: 10px; align-items: center;">
            <button id="scan-btn" class="button button-primary">
                <span class="dashicons dashicons-search"></span>
                <?php _e('Scan Images', 'seo-autofix-pro'); ?>
            </button>
            <?php /* Export CSV button - temporarily hidden
            <button id="export-csv-btn" class="button" style="display: none;">
        ...
        <div class="imageseo-filter-controls"
            style="margin: 20px 0; padding: 20px; background: #fff; border: 1px solid #ddd; border-radius: 4px; display: none;">
            <!-- Filter Section -->
            <div style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                    <h3 style="margin: 0;"><?php _e('Filter Images', 'seo-autofix-pro'); ?></h3>
                    <button id="reset-filter-btn" class="button"
                ...
                <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                    <label
                        style="flex: 1; display: flex; align-items: center; padding: 12px 16px; border: 2px solid #ddd; border-radius: 6px; cursor: pointer; transition: all 0.2s; min-width: 200px;">
                        <input type="radio" name="image-filter" value="with-alt-postpage" style="margin-right: 10px;">
                        <span
                            style="font-size: 14px; font-weight: 500;"><?php _e('Images WITH Alt Text Used in Posts/Pages', 'seo-autofix-pro'); ?></span>
                    </label>
                    <label
                        style="flex: 1; display: flex; align-items: center; padding: 12px 16px; border: 2px solid #ddd; border-radius: 6px; cursor: pointer; transition: all 0.2s; min-width: 200px;">
                        <input type="radio" name="image-filter" value="without-alt-postpage"
                            style="margin-right: 10px;">
                        <span
                            style="font-size: 14px; font-weight: 500;"><?php _e('Images WITHOUT Alt Text Used in Posts/Pages', 'seo-autofix-pro'); ?></span>
                    </label>
                    <label
                        style="flex: 1; display: flex; align-items: center; padding: 12px 16px; border: 2px solid #ddd; border-radius: 6px; cursor: pointer; transition: all 0.2s; min-width: 200px;">
                        <input type="radio" name="image-filter" value="with-alt-all" style="margin-right: 10px;">
                        <span
                            style="font-size: 14px; font-weight: 500;"><?php _e('Images WITH Alt Text IN ALL Media', 'seo-autofix-pro'); ?></span>
                    </label>
                    <label
                        style="flex: 1; display: flex; align-items: center; padding: 12px 16px; border: 2px solid #ddd; border-radius: 6px; cursor: pointer; transition: all 0.2s; min-width: 200px;">
                        <input type="radio" name="image-filter" value="without-alt-all" style="margin-right: 10px;">
                        <span
                            style="font-size: 14px; font-weight: 500;"><?php _e('Images WITHOUT Alt Text IN ALL Media', 'seo-autofix-pro'); ?></span>
                    </label>
                </div>
            </div>
            ...
            <div
                style="display: flex; justify-content: space-between; align-items: center; padding-top: 20px; border-top: 1px solid #e0e0e0;">
                ...
                <?php /* Filter-Scoped CSV Export Button - temporarily hidden
                <button id="export-filter-csv-btn" class="button"
                    style="display: none; padding: 8px 20px; background: #2271b1; color: #fff; border-color: #2271b1;">
                    <span class="dashicons dashicons-download"></span>
            ...
            <div id="bulk-generation-progress"
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                    ...
                    <button id="cancel-generation-btn" class="button"
                        style="padding: 4px 12px; background: #dc3232; color: white; border-color: #dc3232;">
                ...
                <div style="width: 100%; height: 20px; background: #ddd; border-radius: 10px; overflow: hidden;">
                    <div id="progress-bar-fill"
                        style="height: 100%; width: 0%; background: linear-gradient(90deg, #0073aa, #00a0d2); transition: width 0.3s ease;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="clear-suggestions-container" style="display: none; margin: 20px 0; text-align: right;">
            <button id="clear-suggestions-btn" class="button"
                style="padding: 10px 24px; background: #dc3232; color: white; border-color: #dc3232; font-size: 14px;">
...
<div id="tab-cleanup-delete" class="tab-content" style="display: none;">
    ...
    <div class="cleanup-section"
        style="margin: 30px 0; padding: 20px; background: #fff; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <div class="cleanup-section"
        ...
        <textarea id="delete-urls-input" rows="8" style="width: 100%; max-width: 800px; font-family: monospace;"
            placeholder="<?php _e('Paste URLs here, one per line', 'seo-autofix-pro'); ?>"></textarea>
        <div style="margin: 15px 0;">
            <button id="delete-by-url-btn" class="button"
    ...
    <div class="cleanup-section"
        ...
        <button id="bulk-delete-unused-btn" class="button"
            style="background: #dc3232; color: #fff; border-color: #dc3232;">
            <span class="dashicons dashicons-trash"></span>
